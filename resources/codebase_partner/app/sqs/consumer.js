...
const sqs_region = get_sqs_region()
...
function get_sqs_region() {
    if (process.env["SQS_REGION"] === undefined) {
        console.log("[NOTICE] SQS_REGION not found in env, defaulting to 'us-east-1'")
        return "us-east-1"
    }
    return process.env["SQS_REGION"]
}
